    ...
    return (
        <>
            ...
            <TimeRange>
                ...
                >
                    <option key='edit-start-hour-hidden' hidden></option>
                    {HOURS.map((hour, index) => (
                        <option key={'edit-start-hour-' + index}>{hour}</option>
                    ))}
                </Select>
                :
                <Select
                ...
                >
                    <option key={'edit-start-min-hidden'} hidden></option>
                    {MINUTES.map((min, index) => (
                        <option key={'edit-start-min-' + index}>{min}</option>
                    ))}
                </Select>
                <Select
                ...
                >
                    <option key={'edit-start-ap-hidden'} hidden></option>
                    <option key={'edit-start-ap-AM'}>AM</option>
                    <option key={'edit-start-ap-PM'}>PM</option>
                </Select>
                <Arrow>
                    <BsArrowRight/>
                </Arrow>
                ...
                >
                    <option key={'edit-end-hour-hidden'} hidden></option>
                    {HOURS.map((hour, index) => (
                        <option key={'edit-end-hour-' + index}>{hour}</option>
                    ))}
                </Select>
                :
                <Select
                ...
                >
                    <option key={'edit-end-min-hidden'} hidden></option>
                    {MINUTES.map((min, index) => (
                        <option key={'edit-end-min-' + index}>{min}</option>
                    ))}
                </Select>
                <Select
                ...
                >
                    <option key={'edit-end-ap-hidden'} hidden></option>
                    <option key={'edit-end-ap-AM'}>AM</option>
                    <option key={'edit-end-ap-PM'}>PM</option>
                </Select>
            </TimeRange>
        </>
    );
